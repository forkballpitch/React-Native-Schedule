...
export default class Home extends Component {
  ...
  _handleDeletePreviousDayTask =  () => {
    ...
    try {
      ...
      fetch("http://192.168.0.16:3210/data", {
        method: 'GET',
        headers: {
        ...
        .then((data) => {
          ...
          const value = data[0].scheduledata; 
          if (value !== null) {
          ...
          <>
            ...
            >
              <CalendarStrip
                ...
                //daySelectionAnimation={{type: 'background', duration: 300, highlightColor: '#d1d1d1'}}
                style={{height:150, paddingTop: 20, paddingBottom: 20}}
                //calendarHeaderStyle={{color: 'white'}}
                //calendarColor={'#000040'}
                ...
                highlightDateNameStyle={{ color: '#002375' }}
